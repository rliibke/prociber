			...
			<div class="row d-flex align-items-center">
				<div class="col-lg-6 col-md-12 col-sm-12">
					<div class="about-image">
						<img src="assets/img/risk-of-investment-strategy-concept-swith-knob-po-2023-11-27-05-34-41-utc.jpg" alt="image">
					</div>
				</div>
				<div class="col-lg-6 col-md-12 col-sm-12">
					<div class="about-content">
					
						<h2>Evite riscos desnecessários</h2>
                                                <p align="justify">Manter uma cópia <b>segura</b> dos seus dados é uma política que te protege de vários incidentes, sejam eles 
                                                    de naturaza hacker, ou até uma eventual falha em algum dispositivo.
